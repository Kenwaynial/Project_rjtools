...
export default function HeroResult({ isc1, suggestedKAIC }) {
  return (
    <div className="bg-black dark:bg-[#0f172a] border border-white/[0.06] dark:border-slate-700/50 rounded-xl p-5 flex justify-between items-center">
      <div>
        ...
        <div className="font-mono text-3xl font-bold text-primary leading-tight">
          {isc1} <span className="text-base font-medium text-muted dark:text-slate-500">A</span>
        </div>
      </div>
      {suggestedKAIC && (
        <div className="bg-green/5 border border-green/20 rounded-lg px-4 py-2.5 text-center">
          <div className="text-[0.55rem] font-medium text-muted dark:text-slate-400 uppercase tracking-wider">Suggested Breaker</div>
